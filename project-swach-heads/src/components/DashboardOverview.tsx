...
const trendData = [
  ...
  { name: 'Fri', complaints: 30, resolved: 24 },
  { name: 'Sat', complaints: 25, resolved: 20 },
  { name: 'Sun', complaints: 14, resolved: 12 },
];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatsCard title="Total Complaints" value={stats.total} icon={Activity} trend="+12%" trendUp />
        <StatsCard title="Active Issues" value={stats.active} icon={AlertTriangle} trend={stats.active > 10 ? "High Load" : "Normal"} trendUp={stats.active > 10} />
        <StatsCard title="Cleared" value={stats.cleared} icon={CheckCircle} trend={`${Math.round((stats.cleared/stats.total || 0) * 100)}% Rate`} trendUp />
        <StatsCard title="Escalations" value={stats.escalated} icon={Clock} trend="Manual Review" trendUp={false} />
      </div>
